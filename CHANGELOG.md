...
Version format: `0.YMMDD.patch` where YMMDD matches the SuperDB pseudo-version of bundled docs.

## [0.51231.1] - 2025-01-05

### Fixed
- Added missing tools to README (super_info, super_help, super_test_compat, super_complete, super_docs)
...
- Database tools: `super_db_list`, `super_db_query`, `super_db_load`, `super_db_create_pool`
